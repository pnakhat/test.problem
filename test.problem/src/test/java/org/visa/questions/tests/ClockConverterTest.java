...
public class ClockConverterTest {
	...
	public void testQuarterToMidnightScenario(){
		Assert.assertEquals("Quarter To Midnight", converter.getConvertedTime(23, 45));
	}
	
	@Test
	public void testQuarterToNonMidnightScenario(){
		Assert.assertEquals("Quarter To Nineteen", converter.getConvertedTime(18, 45));
	}
	
	
	@Test
	public void testQuarterPastScenario(){
		Assert.assertEquals("Quarter Past Six in evening", converter.getConvertedTime(18, 15));
	}
	
	
	@Test
	public void testJustPastScenario(){
		Assert.assertEquals("Just Past Midnight", converter.getConvertedTime(00, 1));
	}
	...
	public void testToScenarioNonMidnight(){
		Assert.assertEquals("Ten To Five in evening", converter.getConvertedTime(16, 50));
	}
	
	
	@Test
	public void testConversionMethod(){
		Assert.assertEquals("Quarter To Thirteen", converter.calculateConverseTimeBasedOnHourMinute(12, 45));
	}
